...
static  $OJ_DEBUG = false;  //是否开启调试
static  $OJ_LANG = "zh";  //默认语言
static  $OJ_TIMEZONE = "Asia/Shanghai";
static  $OJ_SIM = true;  //显示相似度
static  $OJ_LANGMASK = 0; // Calculator: https://pigeon-developer.github.io/hustoj-langmask/ ; Python only: 4194239
...
static  $OJ_LLM_API_KEY = ""; // 大语言模型接口密钥, 留空表示不启用
static  $OJ_LLM_URL = "https://api.deepseek.com/v1"; // 大语言模型接口地址
static  $OJ_LLM_MODEL = "deepseek-chat"; // 大语言模型名称
...
static  $OJ_SMTP_SERVER = ""; //SMTP服务器
static  $OJ_SMTP_PORT = 465; //SMTP服务器端口
static  $OJ_SMTP_USER_EMAIL = ""; //SMTP服务器的用户邮箱
static  $OJ_SMTP_USER = ""; //SMTP服务器的用户帐号
static  $OJ_SMTP_PASS = ""; //SMTP服务器的用户密码
/* log */
