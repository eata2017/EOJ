...
$MSG_AB_KEYWORD_WARNING = "代码中有禁用的关键词或没有使用必须的关键词！";
$MSG_Time_Limit = "时间限制";
...
$MSG_HELP_ADD_SOLUTION_VIEW_GROUP = "给用户组添加单个题目的答案查看权限。";
$MSG_HELP_ADD_ANSWER_VIEW = "给用户添加单个题目的提交查看权限。";
$MSG_HELP_ADD_ANSWER_VIEW_GROUP = "给用户组添加单个提交的答案查看权限。";
