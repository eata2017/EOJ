...
$MSG_TestRun = "Test Running";
$MSG_Waiting_TestRun = "Pending for test run";
...
$MSG_HELP_ADD_SOLUTION_VIEW_GRUOP = "Add Problem Solution View for User Group.";
$MSG_HELP_ADD_ANSWER_VIEW = "Add Submission Solution View for User.";
$MSG_HELP_ADD_ANSWER_VIEW_GROUP = "Add Submission Solution View for User Group.";
